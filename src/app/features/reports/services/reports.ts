...
export class ReportsService {
	...
	getDailySalesReport(date?: string): Observable<DailySalesReportResponse> {
		...
		return this.http.get<DailySalesReportResponse>(
			`${this.baseUrl}/sales/day`,
			{
				params,
			},
		);
	...
	getSalesRangeReport(
		...
		return this.http.get<SalesRangeReportResponse>(
			`${this.baseUrl}/sales/range`,
			{
				params,
			},
		);
	...
	getTopSellingProductsReport(
		...
		return this.http.get<TopSellingProductsResponse>(
			`${this.baseUrl}/products/top`,
			{
				params,
			},
		);
